...
{
    public static readonly Description Type = new("Type", "Type",
        """
    ...
    public static readonly Description Affiliation = new("Affiliation", "Affiliation",
        """
    ...
    public static readonly Description Visibility = new("Visibility", "Visibility",
        """
