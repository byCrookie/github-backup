...
public class PipingTests
{
    ...
    {
        const string input = "12,23:34;45|56-67 78  89   910";
        var expected = new[] { 12L, 23L, 34L, 45L, 56L, 67L, 78L, 89L, 910L };
        var textReader = new StringReader(input);
    ...
    {
        const string input = "ab,bc:cd;de|e\"Quoted1\"f-'fg' gh  \"hi\"   ij";
        var expected = new[] { "ab", "bc", "cd", "de", "e", "Quoted1", "f", "fg", "gh", "hi", "ij" };
        var textReader = new StringReader(input);
