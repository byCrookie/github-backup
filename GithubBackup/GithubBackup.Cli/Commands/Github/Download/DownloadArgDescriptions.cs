...
{
    public static readonly Description Migrations = new("Migrations", "Migrations", "Id's of the migrations to download. Instead piping can be used to provide the id's.");
