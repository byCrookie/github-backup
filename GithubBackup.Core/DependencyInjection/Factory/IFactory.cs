...
public interface IFactory
{
    ...
    TService Create<TService>(Type type)
        where TService : notnull;
}
...
public interface IFactory<in TParameter, out TImplementation>
    where TImplementation : notnull
{
    TImplementation Create(TParameter parameter);
}

public interface IFactory<in TParameter1, in TParameter2, out TImplementation>
    where TImplementation : notnull
{
    TImplementation Create(TParameter1 parameter1, TParameter2 parameter2);
}

public interface IFactory<in TParameter1, in TParameter2, in TParameter3, out TImplementation>
    where TImplementation : notnull
{
